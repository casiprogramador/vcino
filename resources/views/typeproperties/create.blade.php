            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        {!! Form::open(array('route' => 'config.typeproperty.store', 'class' => 'form-horizontal')) !!}

                            <div class="tabs-container">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a data-toggle="tab" href="#tab-1">Nuevo tipo de propiedad</a></li>
                                </ul>
                                    ...
                                    <div id="tab-1" class="tab-pane active">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group{{ $errors->has('tipo_propiedad') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control input-sm" name="tipo_propiedad" value="{{old('tipo_propiedad')}}">

		...
		<div class="col-lg-12">
			...
			<div class="ibox float-e-margins">
				<div class="ibox-content">
					{!! Form::open(array('route' => array('equipment.machinery.update', $equipment->id),'method' => 'patch' ,'class' => 'form-horizontal', 'files' => true)) !!}
							...
							<div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									...
									<div class="form-group{{ $errors->has('ubicacion') ? ' has-error' : '' }}">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control input-sm" name="ubicacion" value="{{$equipment->ubicacion}}">
									...
									<div class="form-group{{ $errors->has('proveedor') ? ' has-error' : '' }}">
										...
										<div class="col-sm-6">
											{{ Form::select('proveedor',['0' => 'Seleccione un proveedor']+$suppliers,$equipment->supplier_id, ['class' => 'form-control input-sm']) }}
									...
									<div class="form-group{{ $errors->has('notas') ? ' has-error' : '' }}">
										...
										<div class="col-sm-9">
											<textarea id="summernote" name="notas" name="notas">{{ $equipment->notas }}</textarea>
										</div>
										@if ($errors->has('notas'))
										<span class="help-block">
									...
									<div class="form-group{{ $errors->has('documento') ? ' has-error' : '' }}">
										...
										<div class="col-sm-6">
											<div id="adjunto-file-documento" class="fileinput input-group {{!empty($equipment->documento) ? 'fileinput-exists'  : 'fileinput-new'}}" data-provides="fileinput">
												<div class="form-control" data-trigger="fileinput"><i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename">{{ (!empty($equipment->documento) ) ? MenuRoute::filename($equipment->documento) : "" }}</span></div>
												<span class="input-group-addon btn btn-default btn-file">
													<span class="fileinput-new">Seleccionar archivo...</span><span class="fileinput-exists">Cambiar</span>
													<input type="file" name="documento">
													<input type="hidden" id="adjunto-ori-documento" name="adjunto_ori_documento" value="{{ (isset($equipment->documento) ) ? $equipment->documento : '' }}">
												</span>
									...
									<div class="form-group{{ $errors->has('fotografia_1') ? ' has-error' : '' }}">
										...
										<div class="col-sm-6">
											<div id="adjunto-file-fotografia-1" class="fileinput input-group {{!empty($equipment->fotografia_1) ? 'fileinput-exists'  : 'fileinput-new'}}" data-provides="fileinput">
												<div class="form-control" data-trigger="fileinput"><i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename">{{ (!empty($equipment->fotografia_1) ) ? MenuRoute::filename($equipment->fotografia_1) : "" }}</span></div>
												<span class="input-group-addon btn btn-default btn-file">
													<span class="fileinput-new">Seleccionar archivo...</span><span class="fileinput-exists">Cambiar</span>
													<input type="file" name="fotografia_1">
													<input type="hidden" id="adjunto-ori-fotografia-1" name="adjunto_ori_fotografia_1" value="{{ (isset($equipment->fotografia_1) ) ? $equipment->fotografia_1 : '' }}">
												</span>
												<a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Eliminar</a>
											</div>
										</div>
									...
									<div class="form-group{{ $errors->has('fotografia_2') ? ' has-error' : '' }}">
										...
										<div class="col-sm-6">
											<div id="adjunto-file-fotografia-2" class="fileinput input-group {{!empty($equipment->fotografia_2) ? 'fileinput-exists'  : 'fileinput-new'}}" data-provides="fileinput">
												<div class="form-control" data-trigger="fileinput"><i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename">{{ (!empty($equipment->fotografia_2) ) ? MenuRoute::filename($equipment->fotografia_2) : "" }}</span></div>
												<span class="input-group-addon btn btn-default btn-file">
													<span class="fileinput-new">Seleccionar archivo...</span><span class="fileinput-exists">Cambiar</span>
													<input type="file" name="fotografia_2">
													<input type="hidden" id="adjunto-ori-fotografia-2" name="adjunto_ori_fotografia_2" value="{{ (isset($equipment->fotografia_2) ) ? $equipment->fotografia_2 : '' }}">
												</span>
												<a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Eliminar</a>
											</div>
										</div>
									...
									<div class="form-group{{ $errors->has('fotografia_3') ? ' has-error' : '' }}">
										...
										<div class="col-sm-6">
											<div id="adjunto-file-fotografia-3" class="fileinput input-group {{!empty($equipment->fotografia_3) ? 'fileinput-exists'  : 'fileinput-new'}}" data-provides="fileinput">
												<div class="form-control" data-trigger="fileinput"><i class="glyphicon glyphicon-file fileinput-exists"></i> <span class="fileinput-filename">{{ (!empty($equipment->fotografia_3) ) ? MenuRoute::filename($equipment->fotografia_3) : "" }}</span></div>
												<span class="input-group-addon btn btn-default btn-file">
													<span class="fileinput-new">Seleccionar archivo...</span><span class="fileinput-exists">Cambiar</span>
													<input type="file" name="fotografia_3">
													<input type="hidden" id="adjunto-ori-fotografia-3" name="adjunto_ori_fotografia_3" value="{{ (isset($equipment->fotografia_3) ) ? $equipment->fotografia_3 : '' }}">
												</span>
												<a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Eliminar</a>
											</div>
										</div>
...
<script>
	...
	$(document).ready(function () {
		...
		$('#adjunto-file-reglamento').on('clear.bs.fileinput', function(event) {
			...
			$('#adjunto-file-documento').on('clear.bs.fileinput', function(event) {
				$('#adjunto-ori-documento').val('');
			});

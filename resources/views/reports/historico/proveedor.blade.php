        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" style="padding-bottom: 7px;">
                        <div class="btn-group">
                            ...
                            <a href="{{ route('report.historicotransacciones.proveedores.excel', $mes.'_'.$anio.'_'.$proveedor->id.'_'.$fecha_ini.'_'.$fecha_fin) }}" type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="bottom" title="Exportar reporte a Excel" data-original-title="Exportar reporte a Excel">
                ...
                <div class="ibox-content ibox-heading" style="background-color: #ECF7FE">
                    <h3><i class="fa fa-table">&nbsp;&nbsp;</i>Histórico de transacciones - Proveedores</h3>
                    @if($mes != 0)
                ...
                <div class="ibox-content">
                    <div id="printableArea">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 0; vertical-align:bottom">
                                            <div class="p-h-xl text-right">
                                                <h2 style="line-height: 18px; font-size: 19px;">Histórico de transacciones - Proveedores</h2>
                                                @if($mes != 0)
                        ...
                        <div class="col-sm-12">
                        	<div class="row">
    	                    	<div class="col-sm-12">
    	                    		<h3>Proveedor: {{$proveedor->razon_social}}</h3>
    	                    	</div>
    	                    </div>

                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools" style="padding-bottom: 7px;">
                        <div class="btn-group">
                            ...
                            <a href="{{ route('report.historicotransacciones.categorias.excel', $mes.'_'.$anio.'_'.$categoria->id.'_'.$fecha_ini.'_'.$fecha_fin) }}" type="button" class="btn btn-sm btn-default" data-toggle="tooltip" data-placement="bottom" title="Exportar reporte a Excel" data-original-title="Exportar reporte a Excel">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 0; vertical-align:bottom">
                                            <div class="p-h-xl text-right">
                                                <h2 style="line-height: 18px; font-size: 19px;">Histórico de transacciones - Categorías</h2>
                                                @if($mes != 0)
                                ...
                                <table class="table table-hover table-striped texto-impresion tabla-compress">
                                    ...
                                    <tbody>
    									...
    									<tr>
    										...
    										<td>{{$datos[$i][3]}}</td>
    										<td>{{$datos[$i][4]}}</td>
    										<td>{{ucfirst($datos[$i][5])}} {{$datos[$i][7]}}</td>

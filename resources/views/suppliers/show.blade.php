                    ...
                    <div class="ibox-content">
                        ...
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1">Detalle {{$supplier->razon_social}}</a></li>
                            </ul>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" placeholder="# para Emergencias" class="form-control" style="background-color: #ffffe6" name="telefono_emergencia" value="{{ $supplier->telefono_emergencia }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <a href="{{ route('config.supplier.index') }}" class="btn btn-success" >Atras</a>
                                </div>
                            </div>

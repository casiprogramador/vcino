                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group{{ $errors->has('categoria') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-3">
                                                {{ Form::select('categoria',array('0' => 'Seleccione la categoria','Servicios basicos' => 'Servicios basicos', 'Taxis' => 'Taxis', 'Fontaneros' => 'Fontaneros', 'Electricistas' => 'Electricistas', 'Policia y Transito' => 'Policia y Transito', 'Salud' => 'Salud'),$phonesite->categoria,['class' => 'form-control input-sm','disabled'=>'disabled']) }}
                                        ...
                                        <div class="form-group{{ $errors->has('sitio_web') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control input-sm" placeholder="Ej: http://website.com" name="sitio_web" value="{{$phonesite->sitio_web}}" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea rows="4" class="form-control input-sm" name="notas" readonly>{{$phonesite->notas}}</textarea>
                                            </div>
                                        </div>

                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        ...
                        <div class="tabs-container">
                                        ...
                                        <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" placeholder="Tel. Emergencias" class="form-control input-sm" name="telefono_emergencia" value="{{$phonesite->telefono_emergencia}}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <a href="{{ route('communication.phonesite.index') }}" class="btn btn-success" >Volver</a>
                                </div>
                            </div>

            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        {!! Form::open(array('route' => array('config.quota.update', $quota->id),'method' => 'patch' ,'class' => 'form-horizontal', 'files' => true)) !!}

                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1">Editar cuota</a></li>
                            </ul>
                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group{{ $errors->has('cuota') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control input-sm" name="cuota" value="{{ $quota->cuota }}">
                                                @if ($errors->has('cuota'))
                                        ...
                                        <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-5">
                                                {{ Form::select('category',$categories, $quota->category_id, ['class' => 'form-control input-sm']) }}
                                        ...
                                        <div class="form-group{{ $errors->has('type_property') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-5">
                                                {{ Form::select('type_property',$typeProperties,$quota->type_property_id, ['class' => 'form-control input-sm']) }}
                                        ...
                                        <div class="form-group{{ $errors->has('frecuencia_pago') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-5">
                                                {{ Form::select('frecuencia_pago',array('0' => 'Seleccione','Mensual' => 'Mensual', 'Bimestral' => 'Bimestral', 'Semestral' => 'Semestral', 'Anual' => 'Anual', 'Variable' => 'Variable'),$quota->frecuencia_pago,['class' => 'form-control input-sm']) }}
                                        ...
                                        <div class="form-group{{ $errors->has('tipo_importe') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-3">
                                                {{ Form::select('tipo_importe',array('0' => 'Seleccione','Fijo' => 'Fijo', 'Variable' => 'Variable'),$quota->tipo_importe,['class' => 'form-control input-sm']) }}
										...
										<div class="form-group{{ $errors->has('forma_cobro') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-3">
                                                    {{ Form::select('forma_cobro',array('Tipo' => 'Tipo', 'FIT' => 'FIT'),$quota->forma_cobro,['class' => 'form-control input-sm']) }}
                                        ...
                                        <div class="form-group{{ $errors->has('notas') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea rows="3" class="form-control input-sm" name="notas">{{$quota->notas}}</textarea>
                                                @if ($errors->has('notas'))
                                                    <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="checkbox" class="i-checks" name="activa" value="1" {{ ($quota->activa == 1) ? 'checked' : '' }}>
                                            </div>
                                        </div>

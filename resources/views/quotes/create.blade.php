                                    ...
                                    <div id="tab-1" class="tab-pane active">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group{{ $errors->has('importe') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="form-control input-sm" name="importe" step=".01" value="{{old('importe')}}">
                                                    </div>
											...
											<div class="form-group{{ $errors->has('forma_cobro') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-3">
                                                    {{ Form::select('forma_cobro',array('Tipo' => 'Tipo', 'FIT' => 'FIT'),old('forma_cobro'),['class' => 'form-control input-sm']) }}

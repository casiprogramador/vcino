        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
					...
					{!! Form::open(array('route' => array('properties.property.update', $property->id),'method' => 'patch' ,'class' => 'form-horizontal')) !!}
                            ...
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group{{ $errors->has('nro') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
											<input type="text" class="form-control input-sm" name="nro" value="{{ $property->nro }}">
											@if ($errors->has('nro'))
                                    ...
                                    <div class="form-group{{ $errors->has('type_property') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-4">
                                             {{ Form::select('type_property',$typeproperties, $property->type_property_id, ['class' => 'form-control input-sm']) }}
                                    ...
                                    <div class="form-group{{ $errors->has('situacion_habitacionals') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-4">
                                             {{ Form::select('situacion_habitacionals',$sithabs,$property->situacion_habitacionals_id, ['class' => 'form-control input-sm']) }}
                                    ...
                                    <div class="form-group{{ $errors->has('nro_intecomunicador') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
											<input type="text" class="form-control input-sm" name="nro_intecomunicador" value="{{ $property->nro_intecomunicador }}">
                                    ...
                                    <div class="form-group{{ $errors->has('etiquetas') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" name="etiquetas" value="{{ $property->etiquetas }}">
                                    ...
                                    <div class="form-group{{ $errors->has('campo_2') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" name="campo_2" value="{{ $property->campo_2 }}">
                                    ...
                                    <div class="form-group{{ $errors->has('notas') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea rows="6" class="form-control input-sm" name="notas">{{ $property->notas }}</textarea>
                                        </div>
                                    </div>
                            ...
                            <div id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                    <div class="form-group{{ $errors->has('codigo_electricidad') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control input-sm" name="codigo_electricidad" value="{{ $property->codigo_electricidad }}">
                                    ...
                                    <div class="form-group{{ $errors->has('codigo_agua') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control input-sm" name="codigo_agua" value="{{ $property->codigo_agua }}">
                                    ...
                                    <div class="form-group{{ $errors->has('codigo_gas') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control input-sm" name="codigo_gas" value="{{ $property->codigo_gas }}">
                                    ...
                                    <div class="form-group{{ $errors->has('tvservices') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-4">
                                            {{ Form::select('tvservices',$tvs, $property->tvservices_id, ['class' => 'form-control input-sm']) }}
                                    ...
                                    <div class="form-group{{ $errors->has('internetservices') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-4">
                                            {{ Form::select('internetservices',$internets,$property->internetservices_id, ['class' => 'form-control input-sm']) }}
                                    ...
                                    <div class="form-group{{ $errors->has('phone_services') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-4">
                                            {{ Form::select('phone_services',$phones,$property->phone_services_id, ['class' => 'form-control input-sm']) }}
                                    ...
                                    <div class="form-group{{ $errors->has('waterservices') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-4">
                                            {{ Form::select('waterservices',$waters,$property->waterservices_id, ['class' => 'form-control input-sm']) }}
                                    ...
                                    <div class="form-group{{ $errors->has('electricservices') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-4">
                                            {{ Form::select('electricservices',$electrics,$property->electricservices_id, ['class' => 'form-control input-sm']) }}
                            ...
                            <div id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                    <div class="form-group{{ $errors->has('superficie') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
											<input type="text" class="form-control input-sm" name="superficie" value="{{ $property->superficie }}">
                                    ...
                                    <div class="form-group{{ $errors->has('scc') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
											<input type="text" class="form-control input-sm" name="scc" value="{{ $property->scc }}">
											@if ($errors->has('scc'))
												<span class="help-block">
                                    ...
                                    <div class="form-group{{ $errors->has('fit') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
											<input type="text" class="form-control input-sm" name="fit" value="{{ $property->fit }}">
											@if ($errors->has('fit'))
												<span class="help-block">
                                    ...
                                    <div class="form-group{{ $errors->has('nro_dormitorios') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
											<input type="text" class="form-control input-sm" name="nro_dormitorios" value="{{ $property->nro_dormitorios }}"> 
                                    ...
                                    <div class="form-group{{ $errors->has('nro_banos') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
											<input type="text" class="form-control input-sm" name="nro_banos" value="{{ $property->nro_banos }}">
                                    ...
                                    <div class="form-group{{ $errors->has('plano') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
											<input type="text" class="form-control input-sm" name="plano" value="{{ $property->plano }}">
											@if ($errors->has('plano'))
												<span class="help-block">
                                    ...
                                    <div class="form-group{{ $errors->has('caracteristicas') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea rows="4" disable="" class="form-control input-sm" name="caracteristicas" >{{ $property->caracteristicas }}</textarea>

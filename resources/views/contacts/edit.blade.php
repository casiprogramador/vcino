                            ...
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-4{{ $errors->has('telefono_movil') ? ' has-error' : '' }}">
													<input type="text" placeholder="Móvil" class="form-control input-sm" name="telefono_movil" value="{{$contact->telefono_movil}}">
                                                ...
                                                <div class="col-sm-4{{ $errors->has('telefono_domicilio') ? ' has-error' : '' }}">
													<input type="text" placeholder="Domicilio" class="form-control input-sm" name="telefono_domicilio" value="{{$contact->telefono_domicilio}}">
                                                ...
                                                <div class="col-sm-4{{ $errors->has('telefono_oficina') ? ' has-error' : '' }}">
													<input type="text" placeholder="Oficina" class="form-control input-sm" name="telefono_oficina" value="{{$contact->telefono_oficina}}">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <div class="col-sm-6{{ $errors->has('email') ? ' has-error' : '' }}">
													<input type="text" placeholder="E-mail" class="form-control input-sm" name="email" value="{{$contact->email}}">
													@if ($errors->has('email'))
													<span class="help-block">
                                                ...
                                                <div class="col-sm-6"><input type="text" placeholder="E-mail alterno" class="form-control input-sm" name="email_alterno" value="{{$contact->email_alterno}}"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control input-sm" name="direccion" value="{{$contact->direccion}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control input-sm" name="profesion" value="{{$contact->profesion}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control input-sm" name="nacionalidad" value="{{$contact->nacionalidad}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <label><input type="checkbox" class="i-checks" name="mostrar_datos" value="1" {{ ($contact->mostrar_datos == 1) ? 'checked' : '' }}></label>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="checkbox" class="i-checks" name="activa" value="1" {{ ($contact->activa == 1) ? 'checked' : '' }}>
                                        </div>
                                    </div>
